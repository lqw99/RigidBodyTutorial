...
Eigen::Vector3f sImpulseDirs[8] = {
    Eigen::Vector3f(1, 0, 0),          Eigen::Vector3f(0, 0, -1),
    Eigen::Vector3f(-1, 0, 0),         Eigen::Vector3f(0, 0, 1),
    Eigen::Vector3f(0.71f, 0, 0.71f),  Eigen::Vector3f(0.71f, 0, -0.71f),
    Eigen::Vector3f(-0.71f, 0, 0.71f), Eigen::Vector3f(-0.71f, 0, -0.71f)};
...
SimViewer::SimViewer()
    : m_dt(0.0167f), m_subSteps(1), m_paused(true), m_stepOnce(false),
      m_rigidBodySystem() {}
...
void SimViewer::drawGUI() {
  ...
  ImGui::SliderInt("Solver iters.", &(m_rigidBodySystem->solverIter), 1, 100,
                   "%u");
