...
RigidBodySystem::RigidBodySystem()
    : contactStiffness(1e6f), contactDamping(1e5f), mu(0.4f), solverIter(10),
      m_preStepFunc(nullptr), m_resetFunc(nullptr) {
  m_collisionDetect = std::make_unique<CollisionDetect>(this);
  m_solver = new SolverBoxPGS(this);
}

RigidBodySystem::~RigidBodySystem() { clear(); }
...
void RigidBodySystem::step(float dt) {
  ...
  // The list of contacts is automatically cleared and regenerated by
  // detectCollisions(),
  //  and computeContactJacobians() will traverse this list to build contact
  //  Jacobians.
  //
